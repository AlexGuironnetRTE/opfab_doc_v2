...
```
include::../../../../../infra/config/src/main/docker/volume/dev-configurations/actions.yml[]
```

=== Sample docker image configuration

```
include::../../../../../infra/config/src/main/docker/volume/docker-configurations/actions.yml[]
```
