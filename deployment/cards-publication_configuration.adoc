...
```
include::../../../../../infra/config/src/main/docker/volume/dev-configurations/cards-publication.yml[]
```

=== Sample docker image configuration

```
include::../../../../../infra/config/src/main/docker/volume/docker-configurations/cards-publication.yml[]
```
