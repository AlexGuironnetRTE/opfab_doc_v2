...
[source]
----
include::examples/cards-consultation/bootstrap.yml[]
----
...
[source]
----
include::examples/cards-consultation/bootstrap-docker.yml[]
----
...
[source]
----
include::examples/cards-consultation/bootstrap-dev.yml[]
----
